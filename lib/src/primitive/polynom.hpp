#ifdef testPolynom
    #include "../../headers/primitive/polynom.h"
#else
    #include "../lib/headers/primitive/polynom.h"
#endif
...
LinAlg::Matrix<Type> PolynomHandler::Root2Poly(const LinAlg::Matrix<Type> &root)
{
    ...
    {
        tempRoot[1] = std::complex<Type>(-root(i,1),-root(i,2));//apos o templade entre (real,imaginario) atribui\E7\E3o
