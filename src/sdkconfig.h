...
#define CONFIG_ENABLE_ARDUINO_DEPENDS 0
#define CONFIG_AUTOSTART_ARDUINO 0
#define CONFIG_ARDUINO_RUNNING_CORE 0
#define CONFIG_ARDUINO_UDP_RUN_CORE1 0
#define CONFIG_ARDUINO_EVENT_RUN_CORE1 0
...
#define CONFIG_ESP32_DEFAULT_CPU_FREQ_160 0
...
#define CONFIG_BOOTLOADER_WDT_TIME_MS 3000
